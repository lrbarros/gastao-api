...
public class LancamentoResource {
	...
	@GetMapping("/{codigo}")
	@PreAuthorize("hasAuthority('ROLE_PESQUISAR_LANCAMENTO') and #oauth2.hasScope('read')")
	public ResponseEntity<Lancamento> buscarLancamentoPorCodigo(@PathVariable @Valid Long codigo){
		Lancamento lancamentoEncontrado = lancamentoService.buscarLancamento(codigo);
	...
	public ResponseEntity<Lancamento> atualizar(@Valid @RequestBody Lancamento lancamento, @PathVariable Long codigo, HttpServletResponse resp) {
	...
	public void deletar(@Valid @PathVariable Long codigo){
