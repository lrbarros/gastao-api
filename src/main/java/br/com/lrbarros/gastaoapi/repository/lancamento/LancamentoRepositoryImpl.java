...
import br.com.lrbarros.gastaoapi.model.Categoria_;
import br.com.lrbarros.gastaoapi.model.Lancamento;
import br.com.lrbarros.gastaoapi.model.Lancamento_;
import br.com.lrbarros.gastaoapi.model.Pessoa_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery{
	...
	public Page<ResumoLancamento> resumir(LancamentoFilter lancamentoFilter, Pageable pageable) {
		//cria o builder
		CriteriaBuilder builder  = manager.getCriteriaBuilder();
		//para quem ou para que tipo de retorno
		CriteriaQuery<ResumoLancamento> criteria = builder.createQuery(ResumoLancamento.class);
		//onde vai buscar 
		Root<Lancamento> root = criteria.from(Lancamento.class);
		//o que será construido ? um resumolancamento
